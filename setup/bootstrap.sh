...
# Alpine / Wget:
#
# wget https://raw.githubusercontent.com/HariSekhon/lib-java/master/setup/bootstrap.sh && sh bootstrap.sh
#
# Curl:
#
# curl https://raw.githubusercontent.com/HariSekhon/lib-java/master/setup/bootstrap.sh | sh
